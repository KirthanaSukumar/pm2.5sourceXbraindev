...
rnd_brain_loadings = pd.read_csv(join(PROJ_DIR, OUTP_DIR, "rnd-brain_P.csv"), header=0, index_col=0)
...
g.savefig(join(PROJ_DIR, FIGS_DIR, 'rnd-brain_region-LD1.png'), bbox_inches='tight', dpi=600)


sig_regions = rnd_brain_loadings[rnd_brain_loadings['Dimension 1'] < -2.5][['long_region', 'hemisphere', 'V1']]
sig_regions.to_csv(join(PROJ_DIR, OUTP_DIR, 'rnd_ld1-sig_brain_salience.csv'))
...
fig.savefig(join(PROJ_DIR, FIGS_DIR, 'rnd-ap_souce-LD1.png'), bbox_inches='tight', dpi=600)