...
rni_cols <- colnames(df[, grep(pattern = "dmri_rsirnigm.*\\change_score",
                     colnames(df))])
...
png(paste(proj_dir, figs_dir, "rni-no_site-brain_change_residuals.png", sep = "/"),
...
for (i in seq_len(ncol(Group2_residuals))) {
  png(paste(proj_dir, figs_dir, paste("rni-no_site-air_pollution_residuals-qq",
...
png(paste(proj_dir, figs_dir, "rni-no_site-air_pollution_residuals.png", sep = "/"),
    width = 5, height = 5, res = 600, units = "in")
...
for (i in seq_len(ncol(f))) {
  png(paste(proj_dir, figs_dir, paste("rni-no_site-fitted_v_residual", 
...
png(paste(proj_dir, figs_dir, "rni-no_site-apXbrain_corr.png", sep = "/"),
...
png(paste(proj_dir, figs_dir, "rni-no_site-apXbrain_ckorr.png", sep = "/"),
    width = 10, height = 5, res = 600, units = "in")
...
write.csv(scree_df,
          paste(proj_dir, outp_dir,
                paste("rni-no_site-scree_values_",
...
png(paste(proj_dir, figs_dir, "rni-no_site-PLSC_scree.png", sep = "/"),
          width = 5, height = 5, res = 600, units = "in")
...
png(paste(proj_dir, figs_dir, "rni-no_site-LD1_factor_map.png", sep = "/"),
...
plot1
ggsave(plot1, file=paste(proj_dir, figs_dir, "rni-no_site-LD1_factor_map.png", 
                          sep=""), sep = "/"), 
width = 10, height = 10, units = "in", dpi=600)
...
plot2
ggsave(q.plot, file=paste(proj_dir, figs_dir, "rni-no_site-LD2_factor_map.png", 
                          sep=""), sep = "/"), 
width = 10, height = 10, units = "in", dpi=600)
...
p.plot
ggsave(p.plot, file=paste(proj_dir, figs_dir, "rni-no_site-_brain_factors.png", 
                          sep=""), sep = "/"), 
width = 10, height = 10, units = "in", dpi=600)
...
q.plot
ggsave(q.plot, file=paste(proj_dir, figs_dir, "rni-no_site-_air_factors.png", 
                                sep=""), sep = "/"), 
width = 10, height = 10, units = "in", dpi=600)
...
plot_P.data1
ggsave(plot_P.data1, file=paste(proj_dir, figs_dir, "rni-no_site-_brain_P.png", 
                                sep=""), sep = "/"), 
width = 10, height = 10, units = "in", dpi=600)
...
plot_Q.data2
ggsave(plot_Q.data2, file=paste(proj_dir, figs_dir, "rni-no_site-_air_Q.png", 
                                                         sep=""), sep = "/"), 
       width = 10, height = 10, units = "in", dpi=600)
...
write.csv(air_res, paste(proj_dir,
                        outp_dir,
                        "rni-no_site-ap_source_Q.csv",
                        sep = "/"), row.names = TRUE)

write.csv(rni_res, paste(proj_dir,
                        outp_dir,
                        "rni-no_site-brain_P.csv", 
                        sep = "/"), row.names = TRUE)
...
if (resPerm4PLSC$pOmnibus < 0.01) {
  for (i in seq_along(resPerm4PLSC$pEigenvalues)) {
    if (resPerm4PLSC$pEigenvalues[i] < 0.01) {
      laDim <- i
      print(laDim)
      png(paste(proj_dir, figs_dir, paste("rni-no_site-LD", 
                                          i, 
      ...
      ba001.BR1.I
      ggsave(ba001.BR1.I, file=paste(proj_dir, figs_dir, paste("rni-no_site-LD", 
                                                               i, 
                                                               "_brain_saliences.png", 
                                                               sep=""), sep = "/"), 
             width = 10, height = 10, units = "in", dpi=600)
      ...
      ba001.BR1.J
      ggsave(ba001.BR1.J, file=paste(proj_dir, figs_dir, paste("rni-no_site-LD", 
                                                               i, 
                                                               "_air_saliences.png", 
                                                               sep=""), sep = "/"), 
             width = 10, height = 10, units = "in", dpi=600)
