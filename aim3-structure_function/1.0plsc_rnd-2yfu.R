...
png(paste(proj_dir, figs_dir, "rnd-brain_residuals-2yfu.png", sep = "/"),
...
png(paste(proj_dir, figs_dir, "rnd-rsvar_pollution_residuals-2yfu.png", sep = "/"),
    width = 5, height = 5, res = 600, units = "in")
...
png(paste(proj_dir, figs_dir, "rndXrsvar_corr-2yfu.png", sep = "/"),
...
#png(paste(proj_dir, figs_dir, "rndXrsvar_ckorr-2yfu.png", sep = "/"),
#    width = 10, height = 5, res = 600, units = "in")
...
png(paste(proj_dir, figs_dir, "rndXrsfc-PLSC_scree-2yfu.png", sep = "/"),
    width = 5, height = 5, res = 600, units = "in")
...
png(paste(proj_dir, figs_dir, "rndXrsfc-LD1_factor_map-2yfu.png", sep = "/"),
...
ggsave(plot1, file=paste(proj_dir, figs_dir, "rndXrsfc-LD1_factor_map-2yfu.png", 
                         sep="/"),
...
ggsave(plot2, file=paste(proj_dir, figs_dir, "rndXrsfc-LD2_factor_map-2yfu.png", 
                         sep="/"),
       width = 10, height = 10, units = "in", dpi=600)
...
ggsave(p.plot, file=paste(proj_dir, figs_dir, "rndXrsfc-brain_factors-2yfu.png", 
                          sep="/"), 
       width = 10, height = 10, units = "in", dpi=600)
...
ggsave(q.plot, file=paste(proj_dir, figs_dir, "rndXrsfc_factors-2yfu.png", 
                          sep="/"),
       width = 10, height = 10, units = "in", dpi=600)
...
plot_P.data1
ggsave(plot_P.data1, file=paste(proj_dir, figs_dir, "rnd-brain_P-2yfu.png", 
                                sep = "/"), 
       width = 10, height = 10, units = "in", dpi=600)
...
plot_Q.data2
ggsave(plot_Q.data2, file=paste(proj_dir, figs_dir, "rnd-rsfc_Q-2yfu.png", 
                                sep = "/"), 
       width = 10, height = 10, units = "in", dpi=600)
