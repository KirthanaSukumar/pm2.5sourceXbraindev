...
png(paste(proj_dir, figs_dir, "rni-brain_residuals-base.png", sep = "/"),
...
png(paste(proj_dir, figs_dir, "rni-rsvar_pollution_residuals-base.png", sep = "/"),
    width = 5, height = 5, res = 600, units = "in")
...
png(paste(proj_dir, figs_dir, "rniXrsvar_corr-base.png", sep = "/"),
...
#png(paste(proj_dir, figs_dir, "rniXrsvar_ckorr-base.png", sep = "/"),
#    width = 10, height = 5, res = 600, units = "in")
...
png(paste(proj_dir, figs_dir, "rniXrsfc-PLSC_scree-base.png", sep = "/"),
    width = 5, height = 5, res = 600, units = "in")
...
png(paste(proj_dir, figs_dir, "rniXrsfc-LD1_factor_map-base.png", sep = "/"),
...
ggsave(plot1, file=paste(proj_dir, figs_dir, "rniXrsfc-LD1_factor_map-base.png", 
                         sep="/"),
...
ggsave(plot2, file=paste(proj_dir, figs_dir, "rniXrsfc-LD2_factor_map-base.png", 
                         sep="/"),
       width = 10, height = 10, units = "in", dpi=600)
...
ggsave(p.plot, file=paste(proj_dir, figs_dir, "rniXrsfc-brain_factors-base.png", 
                          sep="/"), 
       width = 10, height = 10, units = "in", dpi=600)
...
ggsave(q.plot, file=paste(proj_dir, figs_dir, "rniXrsfc_factors-base.png", 
                          sep="/"),
       width = 10, height = 10, units = "in", dpi=600)
...
plot_P.data1
ggsave(plot_P.data1, file=paste(proj_dir, figs_dir, "rni-brain_P-base.png", 
                                sep = "/"), 
       width = 10, height = 10, units = "in", dpi=600)
...
plot_Q.data2
ggsave(plot_Q.data2, file=paste(proj_dir, figs_dir, "rni-rsfc_Q-base.png", 
                                sep = "/"), 
       width = 10, height = 10, units = "in", dpi=600)
